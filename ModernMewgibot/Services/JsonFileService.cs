...
namespace ModernMewgibot.Services
{
    static class JsonFileService
    {
        ...
        public static void InitializeAllFiles()
        {
            ...
            if (!Directory.Exists(baseDirectory + @".\Settings"))
                Directory.CreateDirectory(baseDirectory + @".\Settings");
            ...
            Task.Factory.StartNew(() => InitializeFile(baseDirectory + @".\Data\regulars.json"));
            Task.Factory.StartNew(() => InitializeFile(baseDirectory + @".\Data\scheduledMessages.json"));
            Task.Factory.StartNew(() => InitializeFile(baseDirectory + @".\Data\whitelist.json"));
            Task.Factory.StartNew(() => InitializeFile(baseDirectory + @".\Settings\botSettings.json"));
            //Task.Factory.StartNew(() => InitializeFile(baseDirectory + @".\Settings\uiSettings.json"));
        ...
        public static async Task SaveToFileAsync<T>(T toSave, string fileNameAndPath)
        {
        ...
        public static async Task<T> LoadFromFileAsync<T>(string fileNameAndPath)
        {
