...
namespace ModernMewgibot.Pages.Settings
{
        ...
        : NotifyPropertyChanged
    {
        ...
        private void SyncThemeAndColor()
        {
            ...
            {
                UserInterface.Default.SelectedThemeDisplayName = this.SelectedTheme.DisplayName;
                UserInterface.Default.SelectedThemeSource = this.SelectedTheme.Source;
                UserInterface.Default.SelectedAccentColor = this.SelectedAccentColor;
                UserInterface.Default.SelectedFontSize = this.SelectedFontSize;
                UserInterface.Default.Save();
            }
        }
